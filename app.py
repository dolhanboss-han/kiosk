...
# 경로 설정
# ================================================================
# BASE_DIR = r"C:\BlueSwell\kiosk\data"
# OUTPUT_DIR = r"C:\BlueSwell\kiosk"
FILE_HOSPITAL = os.path.join(BASE_DIR, "/home/blueswell/지역별_병원관리_리스트.xlsx")
...
def find_latest_kiosk_file():
    pattern = os.path.join(BASE_DIR, "/home/blueswell/bs_kiosk_use_*.xlsx")
